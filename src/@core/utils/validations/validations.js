...
localize({
  en: {
    messages: {
      ...
      password:'Your field must contain at least one uppercase, one lowercase, one special character and one digit',
      decimal: 'The {_field_} field must contain correct values'
    },
    names: {
      email: 'Email',
      password: 'Password',
  ...
  ar: {
    messages: {
      ...
      password:'يجب أن يحتوي الحقل الخاص بك على الأقل على حرف كبير واحد وحرف صغير وحرف خاص واحد ورقم واحد',
      decimal: 'يجب أن يحتوي الحقل {_field_} على قيم صحيحة',
    },
    names: {
